                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                {/* <button type="button" class="btn btn-info btn-rounded float-right"
                                    >New Absent
                                </button> */}
                                            ...
                                            <div class="form-body">
                                                <div class="card-body">
                                                    <div class="row pt-3">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="control-label">Giao vien</label>
                                                                <select class="form-control custom-select">
                                                                    <option value="">Male</option>
                                                                    <option value="">Female</option>
                                                                </select>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <button type="submit"
                                                                        ...
                                                                        style="margin-top:7px"> <i class="fa fa-search-plus"></i>
                                                                        Search</button>
                                                                </div>
                                                            </div>
                                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-addrow" class="table m-t-30 table-hover no-wrap contact-list"
                                        data-paging="true" data-paging-size="8">
                                        <thead>
                                            <tr>
                                                <th>ID #</th>
                                                <th>Opened By</th>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <div id="add-feedback" class="modal fade in" tabindex="-1" role="dialog"
