...
import { actAddProductRequest, actUpdateProductRequest, actGetProductRequest } from '../../redux/actions/index';
...
class ProductActionPage extends Component {
    ...
    render() {
        ...
        // var { txtName, txtDescription, txtPrice, chkbStatus } = this.props;
        return (
