                        ...
                        <div className="mega-container visible-lg visible-md visible-sm">
                          <div className="navleft-container">
                            ...
                            <div className="mega-menu-category">
                              <ul className="nav">
                                <li> <a href="#"><i className="icon fa fa-camera fa-fw" /> Camera &amp; Photo</a>
                                        ...
                                        <div className="col-md-4 has-sep hidden-sm">
                                          <div className="custom-menu-right">
                                            <div className="box-banner menu-banner">
                                              <div className="add-right"><a href="#"><img src="images/menu-img4.jpg" alt="html template" /></a></div>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                ...
                                <li> <a href="#"><i className="icon fa fa-desktop fa-fw" /> Computers</a>
                                  <div className="wrap-popup">
                                    <div className="popup">
                                      <div className="row">
                                        <div className="col-md-4 col-sm-6">
                                        ...
                                        <div className="col-md-4 has-sep hidden-sm">
                                          <div className="custom-menu-right">
                                            <div className="box-banner media">
                                              ...
                                              <div className="add-right"><a href="#"><img src="images/menu-img1.jpg" alt="html template" /></a></div>
                                            </div>
                                            <div className="box-banner media">
                                              <div className="add-desc">
                                                <h3>Save up to</h3>
                                              ...
                                              <div className="add-right"><a href="#"><img src="images/menu-img2.jpg" alt="html template" /></a></div>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                ...
                                <li> <a href="shop_grid.html"><i className="icon fa fa-apple fa-fw" /> Apple Store</a>
                                  <div className="wrap-popup column2">
                                    <div className="popup">
                                      <div className="row">
                                        ...
                                        <div className="col-sm-12"> <a className="ads1" href="#"><img className="img-responsive" src="images/menu-img3.jpg" alt="html template" /></a> </div>
                                      </div>
                                    </div>
                                  </div>
                                </li>
                                <li className="nosub"><a href="#"><i className="icon fa fa-location-arrow fa-fw" /> Car Electronic</a>
                                </li>
                                ...
                                <li><a href="#"><i className="icon fa fa-microphone fa-fw" /> Accessories</a>
                                  <div className="wrap-popup column1">
                                    <div className="popup">
                                      <ul className="nav">
                                ...
                                <li className="nosub"><a href="shop_grid.html"><i className="icon fa fa-gamepad fa-fw" /> Game &amp;
                                    Video</a></li>
                                <li className="nosub"><a href="shop_grid.html"><i className="glyphicon glyphicon-time" /> Watches</a></li>
                                <li className="nosub"><a href="shop_grid.html"><i className="icon fa fa-lightbulb-o fa-fw" /> Lights &amp;
                                    Lighting</a></li>
                              </ul>
                            </div>
                          </div>
